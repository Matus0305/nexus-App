...
const styles = {
  ...
  modalOverlay: { position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(20px)', zIndex: 1000, display: 'flex', justifyContent: 'center', alignItems: 'center' },
  modalGlass: { background: '#0a0a0a', border: '1px solid #1a1a1a', borderRadius: '32px', padding: '30px', width: '90%', maxWidth: '400px' },
  ...
  inputWrap: { display: 'flex', flexDirection: 'column', gap: '8px', flex: 1 },
  label: { fontSize: '0.6rem', color: '#444', fontWeight: 'bold', marginLeft: '5px' },
  input: { background: '#111', border: '1px solid #1a1a1a', padding: '15px', borderRadius: '14px', color: '#fff', fontSize: '0.9rem', outline: 'none' },
